...
- [n3tdom_microservices](#n3tdom_microservices)
  ...
  - [hw-20 kubernetes-4](#hw-20-kubernetes-4)
...
## hw-21
### Основное задание
- Мониторинг с помощью Prometheus в kubernetes
  - Cluster, node metrics
  - reddit app metrics
  - Визуализация в grafana и templating (Для фильтрации  визуализации по параметру)
  - Импорт дашбоардов для k8s из grafana.com
- Логирование
...
## hw-20 kubernetes-4
### Основное задание
- Развертывание приложения и зависимостей с помощью Helm
- Развертывание gitlab с помощью Helm
- Настройка CI/CD в k8s+gitlabci (dynamic, static env, ревью и выкатка в ручную по кнопке)

### Задание со * -
TODO: Не выполнялось
Сейчас у нас выкатка на staging и production - по нажатию кнопки
Свяжите пайплайны сборки образов и пайплайн деплоя на staging
и production так, чтобы после релиза образа из ветки мастер -
запускался деплой уже новой версии приложения на production
